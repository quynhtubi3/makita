...
function HomePage() {
  return (
    <div className="flex justify-center flex-wrap">
      <PageHeader />
      <div className="h-[2000px] z-0 pt-[104px] absolute w-full bg-[url('/src/pictures/Home.png')] bg-cover bg-center">
        <Carousel autoplay>
        ...
        <div className="flex justify-center flex-wrap max-w-[2000px] mx-auto">
          ...
          <div className="font-bold text-[20px] w-[65%] justify-end flex mt-[10px] text-[#FD3939]">
